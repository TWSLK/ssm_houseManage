			...
			<div class="mmDiv">
				...
				<ul>
					...
					<li class="m-Lev1 m-nav_4">
						<a href="news.do" class="menu1 ">新闻动态</a>

					</li>
					<li class="m-Lev1 m-nav_4">
					<a href="showGoodsList_top_man.do" class="menu1 ">出租户型
				...
				<li class="m-Lev1 m-nav_4">
					<a href="showGoodsList_top_man.do" class="menu1 ">求租户型
						<i class="fa fa-caret-down"></i></a>
					<ul class="drop-down sub-menu2">
						<c:forEach items="${tlist }" var="t">
						<li class="m-Lev2 m-nav_4">
							<a href="showGoodsType_cs.do?fid=${t.id }" class="menu2">${t.name }</a>
						</li>
						</c:forEach>
					</ul>
				</li>
