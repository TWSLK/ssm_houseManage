									...
									<form class="add-msg-form" action="addBbs.do"   method="post" ><!-- enctype="multipart/form-data" -->
										...
										<div class="row">
											...
											<label>商品名称：</label>
												...
												<input  type="hidden"  name="name" value="${goods.id }"  readonly="readonly"/>
											</div>
											<div class="cf-column col-md-12"> 
											<label>卖家：</label>
												<input  type="text"  value="${user.tname }"  />
												<input  type="hidden" name="did"  value="${user.uid }"  readonly="readonly" />
											</div>
											...
											<div class="cf-column col-md-12 cf-tarea">
												<textarea name="note" id="content" placeholder="留言内容" ></textarea>
											</div>
