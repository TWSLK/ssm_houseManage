	...
	<body>
		<div id="container">
			...
			<div class="breadcrumb-wrapper">
				<div class="container">
					<div class="row">
						<div class="col-md-3 col-sm-4 bcid-cat">编辑出售</div>
						<div class="col-md-9 col-sm-8 location"><i class="fa fa-map-marker"></i> &nbsp;<span>当前位置： <a href='javascript:;'>主页</a> > <a href='javascript:;'>添加出售</a></span></div>
					</div>
				</div>
			</div>
					...
					<div class="row">
						<div class="main col-md-9 inner-left" role="main">
							<div class="about-page-wrap">
								...
								<div id="contact-wrap">
									<h3 class="msg-title">出售添加</h3>
									<form class="add-msg-form" action="updateGoods_cs.do"   method="post"  enctype="multipart/form-data" ><!-- enctype="multipart/form-data" -->
										
										<div class="row">
											
											<div class="cf-column col-md-12"> 
												<input name="name" type="text" placeholder="出售名称" value="${goods.name }"  />
												<input name="id" type="hidden"  value="${goods.id }"  />
												<span id='checku' class="spanInit" ></span>
											</div>
											<div class="cf-column col-md-12">
												<select name="fid" class="cf-column col-md-12">
														<option value="">请选择出售类型</option>
											...
											<div class="cf-column col-md-12">
											<label>出售图片：</label>
												<input type="file" name="file"  placeholder="选择出售的图片" value="上传图片">
											</div>
											<div class="cf-column col-md-12">
											<label>面积：</label>
