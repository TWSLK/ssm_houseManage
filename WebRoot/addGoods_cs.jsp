	...
	<body>
		<div id="container">
			...
			<div class="breadcrumb-wrapper">
				<div class="container">
					<div class="row">
						<div class="col-md-3 col-sm-4 bcid-cat">添加出售</div>
						...
						<div class="main col-md-9 inner-left" role="main">
							<div class="about-page-wrap">
								...
								<div id="contact-wrap">
									...
									<form class="add-msg-form" action="addGoods_cs.do"   method="post"  enctype="multipart/form-data" ><!-- enctype="multipart/form-data" -->
										
										<div class="row">
											
											<div class="cf-column col-md-12"> 
												<input name="name" type="text" placeholder="出售名称"  />
