...
<body>
 ...
 <article class="page-container">
	 ...
	 <form class="form"  action="updateGoods_cs_admin.do"  method="post" enctype="multipart/form-data"  ><!-- enctype="multipart/form-data" -->
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>房屋名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${goods.name }"  placeholder="请输入房屋名称" id="articletitle" name="name">
				<input type="hidden"  value="${goods.id }" name="id">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>房屋类别：</label>
			<div class="formControls col-xs-8 col-sm-9">
			<select name="fid">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"   placeholder="请输入房屋面积" id="articletitle" name="area" value="${goods.area }">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>单价：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"   placeholder="请输入房屋单价" id="articletitle" name="price" value="${goods.price }">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>地址：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"   placeholder="请输入房屋地址" id="articletitle" name="addr" value="${goods.addr }">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>联系人：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"   placeholder="请输入" id="articletitle" name="tname" value="${goods.tname }">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>联系人电话：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"   placeholder="请输入" id="articletitle" name="tel" value="${goods.tel }">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">内容：</label>
			<div class="formControls col-xs-8 col-sm-9"> 
			<textarea id="editor_id" id="note" name="note" style="width:100%;height:400px;" >${goods.note }</textarea>
