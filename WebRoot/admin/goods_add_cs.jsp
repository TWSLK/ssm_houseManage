...
<body>
 ...
 <article class="page-container">
	 ...
	 <form class="form"  action="addGoods_cs_admin.do"  method="post" enctype="multipart/form-data"  ><!-- enctype="multipart/form-data" -->
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>房屋名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"   placeholder="请输入房屋名称" id="articletitle" name="name">
			</div>
		</div>
			<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>房屋户型：</label>
			<div class="formControls col-xs-8 col-sm-9">
			<select name="fid">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"   placeholder="请输入房屋面积" id="articletitle" name="area">
			</div>
		</div>
		<div class="row cl">
