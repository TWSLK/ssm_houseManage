	...
	<body>
		<div id="container">
			...
			<div class="breadcrumb-wrapper">
				<div class="container">
					<div class="row">
						<div class="col-md-3 col-sm-4 bcid-cat">出售房屋信息</div>
						<div class="col-md-9 col-sm-8 location"><i class="fa fa-map-marker"></i> &nbsp;<span>当前位置： <a href='javascript:;'>主页</a> > <a href='javascript:;'>出售房屋信息</a> > </span></div>
					</div>
				</div>
			</div>
					...
					<div class="row">
								...
								<div id="portfolio-container">
									...
									<c:forEach items="${list }" var="u">
										<div class="portfolio-item isotope-item col-sm-4 col-xs-6">
											<article>
												...
												<h5 class="item-title"> <a href="showGoodsx.do?id=${u.id }" title="${u.name }">出售房屋名称：${u.name }</a> </h5>
												<h5 class="item-title"> <a href="showGoodsx.do?id=${u.id }" title="${u.name }">户型：
									...
									<c:if test="${sessionScope.p==1 }">
										<c:if test="${page.page>1}">
							             <a href="showGoodsList_cs.do?page=1" >首页</a>
							             <a href="showGoodsList_cs.do?page=${page.page-1 }"> 上一页</a> 
							             </c:if>
							    	     <c:if test="${page.page<page.totalPage}">
									     <a href="showGoodsList_cs.do?page=${page.page+1 }">下一页</a>
										 <a href="showGoodsList_cs.do?page=${page.totalPage }">末页</a>
									    </c:if>
									    </c:if>
										...
										<c:if test="${page.page>1}">
							             <a href="showGoodsList_cs_commend.do?page=1" >首页</a>
							             <a href="showGoodsList_cs_commend.do?page=${page.page-1 }"> 上一页</a> 
							             </c:if>
							    	     <c:if test="${page.page<page.totalPage}">
									     <a href="showGoodsList_cs_commend.do?page=${page.page+1 }">下一页</a>
										 <a href="showGoodsList_cs_commend.do?page=${page.totalPage }">末页</a>
									    </c:if>
									    </c:if>
						...
						<aside class="sidebar col-md-3 inner-right" role="complementary">
							<section class="widget side-search">
								...
								<form class="searchform" id="searchform" name="formsearch" method="post" action="selectGoodsList_cs.do">
									<input type="hidden" name="kwtype" value="0" />
									<div class="sform-div">
										<input type="text"  name="name" placeholder="输入出售房屋名称" id="s" />
