	...
	<body>
		<div id="container">
			...
			<div class="breadcrumb-wrapper">
				<div class="container">
					<div class="row">
						<div class="col-md-3 col-sm-4 bcid-cat">编辑求租</div>
						<div class="col-md-9 col-sm-8 location"><i class="fa fa-map-marker"></i> &nbsp;<span>当前位置： <a href='javascript:;'>主页</a> > <a href='javascript:;'>添加求租</a></span></div>
					</div>
				</div>
			</div>
					...
					<div class="row">
						<div class="main col-md-9 inner-left" role="main">
							<div class="about-page-wrap">
								...
								<div id="contact-wrap">
									<h3 class="msg-title">求租添加</h3>
									<form class="add-msg-form" action="updateGoods_qz.do"   method="post"  enctype="multipart/form-data" ><!-- enctype="multipart/form-data" -->
										
										<div class="row">
											
											<div class="cf-column col-md-12"> 
												<input name="name" type="text" placeholder="求租名称" value="${goods.name }"  />
												<input name="id" type="hidden"  value="${goods.id }"  />
												<span id='checku' class="spanInit" ></span>
											</div>
											<div class="cf-column col-md-12">
												<select name="fid" class="cf-column col-md-12">
														<option value="">请选择求租类型</option>
											...
											<div class="cf-column col-md-12">
											<label>求租图片：</label>
												<input type="file" name="file"  placeholder="选择求租的图片" value="上传图片">
											</div>
											<div class="cf-column col-md-12">
											<label>面积：</label>
												<input type="text" name="area"  value="${goods.area }"  placeholder="请输入房屋面积" id="articletitle" name="area" >
											</div>
											<div class="row cl">
											<div class="cf-column col-md-12"><label>单价：</label>
													<input type="text" class="input-text"  value="${goods.price }"  placeholder="请输入房屋单价" id="articletitle" name="price">
											</div>
											</div>
											<div class="cf-column col-md-12"><label>地址：</label>
													<input type="text" class="input-text"  value="${goods.addr }" placeholder="请输入房屋地址" id="articletitle" name="addr">
											</div>
											<div class="cf-column col-md-12"><label>联系人：</label>
													<input type="text" class="input-text" value="${goods.tname }"  placeholder="请输入" id="articletitle" name="tname">
											</div>
											<div class="cf-column col-md-12"><label>联系人电话：</label>
													<input type="text" class="input-text" value="${goods.tel }"  placeholder="请输入" id="articletitle" name="tel">
											</div>
		
											<div class="cf-column col-md-12">
											<label >说明：</label>
												<textarea rows="" cols="" name="note" id="editor_id">${goods.note }</textarea>
											</div>
